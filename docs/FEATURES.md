...
- **No database for the night itself.** A bar night is ephemeral. Only venues, floor plans,
  tickets, paired devices and staff accounts persist (Postgres, or JSON on disk without one) —
  no game history, no chat archive. A planned restart carries the live rooms across in a
